...
generated_at_utc: 2026-06-16T21:10:46Z
...
| Prospect pilot rehearsal | **saving **97.6%** · J **1.0000** (30-case)** | `compression_b2b_pilot_roi_report_v1_latest.json` · **shared API PoC — NOT Handoff · NOT Track A** |
