...
generated_at_utc: 2026-06-17T15:04:12Z
...
| Golden40 public-safe | **saving **7.9%** · J **0.8991** (40-case public-safe)** | `stateless_poc_golden40_public_safe_v1.jsonl` · **not customer SLA** |
| Prospect pilot rehearsal | **saving **21.8%** · J **0.8056** (50-case)** | `compression_b2b_pilot_roi_report_v1_latest.json` · **shared API PoC — NOT Handoff · NOT Track A** |
