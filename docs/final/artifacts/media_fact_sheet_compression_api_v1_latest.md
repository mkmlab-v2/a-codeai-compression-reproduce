...
generated_at_utc: 2026-06-16T20:41:06Z
...
| Prospect pilot rehearsal | **saving **19.0%** · J **0.8334** (30-case)** | `compression_b2b_pilot_roi_report_v1_latest.json` · **shared API PoC — NOT Handoff · NOT Track A** |
