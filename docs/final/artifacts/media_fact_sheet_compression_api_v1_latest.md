...
generated_at_utc: 2026-06-17T03:50:02Z
...
| Prospect pilot rehearsal | **saving **0.0%** · J **0.0000** (24-case)** | `compression_b2b_pilot_roi_report_v1_latest.json` · **shared API PoC — NOT Handoff · NOT Track A** |
