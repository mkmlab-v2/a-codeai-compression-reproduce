...
generated_at_utc: 2026-06-17T08:21:33Z
...
| Prospect pilot rehearsal | **saving **15.7%** · J **0.8656** (30-case)** | `compression_b2b_pilot_roi_report_v1_latest.json` · **shared API PoC — NOT Handoff · NOT Track A** |
